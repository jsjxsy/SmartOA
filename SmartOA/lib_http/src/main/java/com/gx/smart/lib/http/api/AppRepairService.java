...
public class AppRepairService {
     ...
     * @return callBack返回值
     */
    public GrpcAsyncTask<String, Void, CommonResponse> addRepair(final String content,
                                                                 final int type,
                                                                 final String address,
                                                                 final String employee_phone,
     ...
     * @return callBack返回值
     */
    public GrpcAsyncTask<String, Void, RepairCommonResponse> queryMyRepair(final QueryDto query, CallBack callBack) {
